...
namespace EF_Turismo.Controllers
{
    ...
    public class CityModelsController : ControllerBase
    {
        ...
        public CityModelsController(EF_TurismoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CityModel>> PostCityModel(CityModel cityModel)
        {
          if (_context.CityModel == null)
          {
              return Problem("Entity set 'EF_TurismoContext.CityModel'  is null.");
          }
        ...
        {
            return (_context.CityModel?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
